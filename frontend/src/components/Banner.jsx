      ...
      <div className={bannerStyles.content}>
        ...
        <div className={bannerStyles.contentInner}>
          ...
          <p className={bannerStyles.description}>
            An epic adventure on the waves. Explore the mysteries of the deep
            ocean and discover treasures beyond imagination in this
            breathtaking cinematic experience.
          </p>

          {/* ⭐ Rating + Genre in same line */}
          <div className={bannerStyles.ratingGenreContainer}>
            ...
            <span className={bannerStyles.genreText}>
              Adventure • Fantasy • Drama
            </span>
          </div>

          {/* ✅ Buttons moved to NEXT LINE */}
