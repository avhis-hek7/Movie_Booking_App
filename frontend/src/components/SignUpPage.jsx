...
const SignUpPage = () => {
  ...
  // function to validate whether all feilds are filled or not.
  const validateForm = () => {
    const newErrors = {};
            ...
            <form onSubmit={handleSubmit} className={signUpStyles.form}>
              <div className={signUpStyles.formGrid}>
                <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="text" name="fullName" id="fullName" required value={formData.fullName} onChange={handleChange} className={`${signUpStyles.input.base} 
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="text" name="username" id="username" required value={formData.username} onChange={handleChange} className={`${signUpStyles.input.base} 
              ...
              <div className={signUpStyles.formGrid}>
                 <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="text" name="email" id="email" required value={formData.email} onChange={handleChange} className={`${signUpStyles.input.base} 
                 ...
                 <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="tel" name="phone" id="phone" required value={formData.phone} onChange={handleChange} className={`${signUpStyles.input.base} 
                      ${errors.phone ? signUpStyles.input.error : signUpStyles.input.normal}
                      ${signUpStyles.inputWithIcon}
                      `}
                      placeholder="+977 9804167307"
                      />
                      <div className={signUpStyles.inputIcon}>
                        <Phone size={18} />
              ...
              <div className={signUpStyles.formGrid}>
                 <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type="date" name="birthDate" id="birthDate" required value={formData.birthDate} onChange={handleChange} className={`${signUpStyles.input.base} 
                 ...
                 <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                    <input type={showPassword ? 'text' : 'password'} name="password" id="password" required value={formData.password} onChange={handleChange} className={`${signUpStyles.input.base} 
